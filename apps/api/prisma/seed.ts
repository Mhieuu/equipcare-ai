...
const ADMIN_PERMISSIONS: string[] = [
  ...
  P.INCIDENT_CREATE, P.INCIDENT_READ, P.INCIDENT_TRANSITION, P.INCIDENT_MESSAGE_CREATE,
  P.INCIDENT_TRIAGE, P.INCIDENT_CLOSE, P.INCIDENT_REJECT,
  ...
  P.APPROVAL_CREATE, P.APPROVAL_UPDATE_DRAFT, P.APPROVAL_SUBMIT, P.APPROVAL_DECIDE, P.APPROVAL_REQUEST_INFO, P.APPROVAL_CANCEL,
  P.INVENTORY_PART_READ, P.INVENTORY_PART_CREATE, P.INVENTORY_ISSUE, P.INVENTORY_RECEIPT, P.INVENTORY_TRANSFER, P.INVENTORY_ADJUST, P.INVENTORY_RETURN,
  P.COST_READ, P.COST_CREATE,
...
const MANAGER_PERMISSIONS: string[] = [
  ...
  P.INCIDENT_READ, P.INCIDENT_TRANSITION, P.INCIDENT_MESSAGE_CREATE,
  P.INCIDENT_TRIAGE, P.INCIDENT_CLOSE, P.INCIDENT_REJECT,
  P.WORK_ORDER_CREATE, P.WORK_ORDER_READ, P.WORK_ORDER_ASSIGN, P.WORK_ORDER_TRANSITION, P.WORK_ORDER_COMPLETE, P.WORK_ORDER_CANCEL,
  P.APPROVAL_CREATE, P.APPROVAL_UPDATE_DRAFT, P.APPROVAL_SUBMIT, P.APPROVAL_DECIDE, P.APPROVAL_REQUEST_INFO, P.APPROVAL_CANCEL,
  P.INVENTORY_PART_READ, P.INVENTORY_ISSUE, P.INVENTORY_RETURN, P.INVENTORY_RECEIPT,
  P.COST_READ, P.COST_CREATE,
  P.MAINTENANCE_PLAN_READ, P.MAINTENANCE_PLAN_MANAGE,
  P.DASHBOARD_VIEW, P.REPORT_EXPORT,
  P.ATTACHMENT_UPLOAD, P.ATTACHMENT_READ,
...
const TECHNICIAN_PERMISSIONS: string[] = [
  ...
  P.APPROVAL_CREATE, P.APPROVAL_SUBMIT, P.APPROVAL_CANCEL,
  P.COST_CREATE,
  P.INVENTORY_PART_READ, P.INVENTORY_ISSUE, P.INVENTORY_RETURN,
  P.ATTACHMENT_UPLOAD, P.ATTACHMENT_READ,
  P.DOCUMENT_READ,
];
...
async function main(): Promise<void> {
  ...
  // P.XXX là { KEY: 'code' }, nên cần Object.values() để lấy string code.
